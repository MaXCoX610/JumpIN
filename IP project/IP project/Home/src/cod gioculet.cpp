...
{ 
    ...
    {
        circle(x+20, yc-=5, r);
        floodfill(x+20, yc, RGB(159, 98, 5));
        circle(x-20, yc, r);
        floodfill(x-20, yc, RGB(159, 98, 5));
    }
    for(int r=9; r>=5; r--)
...
void rabbit2(int x, int y)
{
    ...
    {
        circle(x+20, yc-=5, r);
        floodfill(x+20, yc, RGB(167, 169, 172));
        circle(x-20, yc, r);
        floodfill(x-20, yc, RGB(167, 169, 172));
    }
    for(int r=9; r>=5; r--)
...
void cover(int px, int py)
{
    ...
    setfillstyle(SOLID_FILL, RGB(0, 172, 79));
    rectangle(px+75,py+75,px-75,py-75);
    floodfill(px,py,RGB(0, 172, 79));
    if (px == 130 && py == 130 || px == 770 && py == 770 || px == 130 && py == 770 || px == 770 && py == 130 || px == 450 && py == 450)
    {
        setcolor(RGB(69, 50, 20));
        setfillstyle(SOLID_FILL, RGB(69, 50, 20));
        circle(px, py, 50);
        floodfill(px, py, RGB(69, 50, 20));
    }
    else
    {
        setcolor(GREEN);
...
void congrats1()
{
    ...
    readimagefile("lvl1done.jpg", 0, 0, 1050, 591);
...
void congrats2()
{
    ...
    readimagefile("lvl2done.jpg", 0, 0, 800, 450);
    settextstyle(4, HORIZ_DIR, 2);
    outtextxy(30, 225, "Congrats on clearing level 2!");
    settextstyle(4, HORIZ_DIR, 2);
...
void startscreen()
{
    ...
    outtextxy(70, 500, " forward or backward and cannot jump over");
